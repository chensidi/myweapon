$(document).ready(function(){
	...
	function probability(){
		...
		// num = 0;
		if ( num == 0 ) {
			angles = 2160 * rotNum + 1800 + 22.5;
			notice = info[0] + info1[0];
		}
		//概率
		else if ( num == 1 ) {
			angles = 2160 * rotNum + 1845 + 22.5;
			notice = info[7] + info1[7];
		}
		//概率
		else if ( num == 2 ) {
			angles = 2160 * rotNum + 1890 + 22.5;
			notice = info[6] + info1[6];
		}
		//概率
		else if ( num == 3 ) {
			angles = 2160 * rotNum + 1935 + 22.5;
			notice = info[5] + info1[5];
		}
		//概率
		else if ( num == 4 ) {
			angles = 2160 * rotNum + 1980 + 22.5;
			notice = info[4] + info1[4];
		}
		//概率
		else if ( num == 5 ) {
			angles = 2160 * rotNum + 2025 + 22.5;
			notice = info[3] + info1[3];
		}
		//概率
		else if ( num == 6 ) {
			angles = 2160 * rotNum + 2070 + 22.5;
			notice = info[2] + info1[2];
		}
		//概率
		else if ( num == 7 ) {
			angles = 2160 * rotNum + 2115 + 22.5;
